...
subnets = {
  frontend = {
    subnet_name          = "exxon-frontend-subnet01"
    rg_key               = "rg1"
    virtual_network_name = "vnet1"
    address_prefixes     = ["192.168.0.0/24"]
  }
  backend = {
    subnet_name          = "exxon-backend-subnet01"
    rg_key               = "rg1"
    virtual_network_name = "vnet1"
...
sql_servers = {
  server1 = {
    sqlserver_name    = "exxon-mssqlsrv001"
    rg_key            = "rg1"
    kv_name           = "assignment-kvexxon"
    location          = "westus"
    version           = "12.0"
...
bastions = {
  "bastion1" = {
    bastion_host_name = "exxon-bastion-host"
    location          = "westus"
    rg_key            = "rg1"
    subnet_name       = "AzureBastionSubnet"
    vnet_name         = "vnet1"
